...
插件和后台只接触平台不透明 ID。项目生命周期、项目角色和资产隔离的总规则见 [服务API-项目管理需求文档](服务API-项目管理需求文档.md)；插件交互见 [插件-知识库设计文档](https://github.com/STXR-1116/AI-coding-plugin/blob/main/docs/%E6%8F%92%E4%BB%B6-%E7%9F%A5%E8%AF%86%E5%BA%93%E8%AE%BE%E8%AE%A1%E6%96%87%E6%A1%A3.md)；后台页面见 [后台管理-知识库设计文档](后台管理-知识库设计文档.md)。
